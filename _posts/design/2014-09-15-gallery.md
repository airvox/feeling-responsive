...
Add the include whereever you want in your content with `{% raw %}{% include gallery.html %}{% endraw %}`.

{% include alert.html info='Have a look at this example-entry. And have a look into the images-folder. :)' %}
